...
export class ViewDppiComponent {
  ...
  buttons: ButtonData[] = [
    ...
    { eb_icon: 'restaurant', eb_title: 'Situación Nutricional', eb_subtitle: '', eb_disable: true, eb_bg_color: '#5eead4', eb_text_color: '#115e59', eb_link: '/dppi/situacion-nutricional' },
