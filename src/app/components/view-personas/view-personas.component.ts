...
export class ViewPersonasComponent {
  ...
  buttons: ButtonData[] = [
    ...
    { eb_icon: 'person_off', eb_title: 'Vacancia de la planta', eb_subtitle: '', eb_disable: true, eb_bg_color: '#5eead4', eb_text_color: '#115e59', eb_link: '' },
    { eb_icon: 'today', eb_title: 'Días LM (Planta)', eb_subtitle: '', eb_disable: true, eb_bg_color: '#5eead4', eb_text_color: '#115e59', eb_link: '' },
    { eb_icon: 'school', eb_title: 'LM por trabajador de planta', eb_subtitle: '', eb_disable: true, eb_bg_color: '#5eead4', eb_text_color: '#115e59', eb_link: '' },
    { eb_icon: 'menu_book', eb_title: 'Días LM por Licencia (Planta)', eb_subtitle: '', eb_disable: true, eb_bg_color: '#5eead4', eb_text_color: '#115e59', eb_link: '' },
    { eb_icon: 'apartment', eb_title: 'Cantidad LM (Planta)', eb_subtitle: '', eb_disable: true, eb_bg_color: '#5eead4', eb_text_color: '#115e59', eb_link: '' },
    { eb_icon: 'calendar_today', eb_title: 'Días LM por trabajador de planta', eb_subtitle: '', eb_disable: true, eb_bg_color: '#5eead4', eb_text_color: '#115e59', eb_link: '' }
  ];
