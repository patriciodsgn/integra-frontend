...
export class ViewPersonasComponent {
  ...
  buttons: ButtonData[] = [
    ...
    { eb_icon: 'groups', eb_title: 'Planta Contratada', eb_subtitle: 'Ejemplo', eb_disable: true, eb_bg_color: '#5eead4', eb_text_color: '#115e59', eb_link: '/personas/planta-contratada' },
