...
export interface PorcentajeTransitorioResponse {
    success: boolean;
    data: PorcentajeTransitorioData[];
    count: number;
    params: {
        ano: number;
        codigoRegion: number;
...
export interface PorcentajeTransitorioData {
    region: string;
    comuna: string;
    porcentajeTransitorio: number;
    cantidadTransitoria: number;
    cantidadTotal: number;
}
